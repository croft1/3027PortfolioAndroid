...
public class BasicViewListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ReminderItemAdapter(this, basicReminders);
    ...
    protected void onListItemClicked(View v) {
       //super.onListItemClick(l, v, position, id);
        ...
        BasicReminder r = basicReminders.get(reminderListView.indexOfChild(v));
        Intent intent = new Intent(this, BasicViewDetailedReminderActivity.class);
